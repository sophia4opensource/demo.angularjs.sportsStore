...
.constant("orderListActiveClass", "btn-primary")
...
.controller("ordersCtrl", function($scope, $http, ordersUrl, orderListActiveClass) {
	...
	$scope.getOrderClass = function(order) {
		return $scope.selectedOrder == order ? orderListActiveClass : "";
	};
});